...
| LOGI-0005 | Driver CRUD + user link | 🟡 IN PROGRESS — architect ✅ (`a3a369d`, spec AC-1..AC-9 `spec_approved` + `/drivers` contract +149/−0, spectral 0 errors, human checkpoint approved) · backend ✅ (`c615744`, dotnet 42/42, migration `20260921041528_LOGI-0005_AddDrivers`) · frontend ✅ (`f3c8e72`, vitest 41/41 incl. 16 driver specs, typed-client regen zero-diff, tsc+build clean) · qa ⬜ |
