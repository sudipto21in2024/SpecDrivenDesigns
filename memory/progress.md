...
| LOGI-0006 | Shipment status lifecycle (BR-7 TransitionTo) | 🟨 IN PROGRESS — architect ✅ (spec_approved, contract additive 96+/0-) + backend ✅ (`ecce789`, dotnet 50/50, migration 20260922095953) + frontend ✅ (BR-7 seam: schema regen +158, client types/methods, permissions A/D/Driver transition + all-role history view, MSW shipments handlers; vitest 41/41, tsc/build clean) — qa arm pending (e2e AC-1..AC-8) |
