...
| `src/backend/LogiFlow.Application/Common/ConflictException.cs` | modify | Additive message-only ctor for the AC-4 409 detail (deviation: added per PLAN_DEVIATION 2026-09-22) | ~8 |
